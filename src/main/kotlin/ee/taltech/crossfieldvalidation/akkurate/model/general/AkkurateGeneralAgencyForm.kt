...
data class AkkurateGeneralAgencyForm(
    ...
    override val socialMedia: List<AkkurateGeneralAgencySocialMedia>,
    override val height: AkkurateGeneralAgencyHeight,
    override val weight: AkkurateGeneralAgencyWeight
) : AkkurateAgencyForm()
